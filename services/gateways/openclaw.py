...
_PROMPT_FILE = os.path.join(
    ...
    'prompts', 'voice-system-prompt.md'
)
_PROMPT_FALLBACK = (
...
def _load_generated_tracks() -> str:
    ...
    try:
        ...
        return (
            f"\n\nGenerated playlist (generated_music folder) — {len(titles)} tracks: {track_list}. "
            "To play a specific song use [MUSIC_PLAY:exact title]. "
            "The playlist is set to 'generated' so [MUSIC_PLAY] without a title plays a random track. "
